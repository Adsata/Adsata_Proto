...
public class UserServiceImpl implements UserService {
    ...
    @Transactional(value = "Adsata1TransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "Adsata1TransactionManager")
    @Override
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "Adsata1TransactionManager")
    @Override
    ...
    @Transactional(readOnly = true, value = "Adsata1TransactionManager", timeout = 300)
    @Override
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service Adsata1 for table User to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service Adsata1 for table User to {} format", options.getExportType());
