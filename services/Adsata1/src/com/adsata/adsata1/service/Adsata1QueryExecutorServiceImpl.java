...
@Service
public class Adsata1QueryExecutorServiceImpl implements Adsata1QueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(Adsata1QueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("Adsata1WMQueryExecutor")
